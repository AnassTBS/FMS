    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            new ApexCharts(document.querySelector("#statusChart"), {
                series: [{{ $chart_data['delivery_status']['assigned'] }}, {{ $chart_data['delivery_status']['in_transit'] }}, {{ $chart_data['delivery_status']['delivered'] }}],
                chart: { type: 'donut', height: 320 },
                labels: ['Assigned', 'In Transit', 'Delivered'],
